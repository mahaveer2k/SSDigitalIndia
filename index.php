            ...
            <div class=" d-inline-block my-1 card col-md-6 text-center" ng-repeat="file in files">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="qtyn" class="form-control" ng-model="items[$index].quantity" ng-if="items[$index].size != 32"
                            style="font-size: small;color: #d87715;" ng-disabled="!files.length">
    ...
    <div class="text-center align-items-center bg-white">
        <p>
            <button id="porder" class="btn btn-success font-weight-bold" data-toggle1="modal"
                data-target="#registerModal" ng-disabled=" !grandAmountArray.length || !files.length" ng-click="upload()">Place
                Order</button>
        </p>
