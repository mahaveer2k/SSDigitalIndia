...
<div class="main">
    ...
    <span><input type="hidden" id="key" name="key" placeholder="Merchant Key" value="aJMIEQV4" /></span>
    </div>

    <div class="dv">
    <!-- <span class="text"><label>Merchant Salt:</label></span> -->
    <span><input type="hidden" id="salt" name="salt" placeholder="Merchant Salt" value="6ShWIUoEIp" /></span>
		</div>
		<?php
...
?>
    ...
    <span><input type="text" id="amount" name="amount" placeholder="Amount" value="6.00" readonly /></span>
    </div>
    ...
    <span><input type="text" id="mobile" name="mobile" placeholder="Mobile/Cell Number" value="" /></span>
		...
		<?php
// $hashSequence =    "aJMIEQV4|$txnid|6.00|P01,P02|akshay|akshay|udf1|udf2|udf3|udf4|udf5||||||salt";
