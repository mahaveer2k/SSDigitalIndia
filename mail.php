...
$html = '<div style="padding: 20px; background:#F3F3F3"><p style="text-align: center; ">'.
 ...
 '<p style="text-align: center; ">'.
  '<br></p><h2 style="text-align: center; "><b>Thank You for your order, Akshay Rana.</b></h2><h3 style="text-align: center; ">Here is your confirmation for order number.</h3><p style="text-align: center;">    <br></p><p style="text-align: center;">    <br></p><p style="text-align: center;">    <br></p><table class="table table-bordered" style="text-align: left; border-collapse:collapse;">    <tbody>        <tr>            <td style="text-align: center; "><b style="color: rgb(255, 156, 0);">Image Size</b></td>            <td style="text-align: center; "><b>Quantity</b></td>            <td style="text-align: center; "><b>Rate</b></td>            <td style="text-align: center; "><b style="color: rgb(57, 123, 33);">Total Price</b></td> </tr>';
  ...
  $stmt->execute();
   ...
   while($row= $result->fetch_assoc()){
      ...
      $html .=   '<tr><td style="text-align: left;">'.$row["size"].' </td><td style="text-align: left;">'.$row["quantity"].' </td><td style="text-align: left;"> '.$rateJson[$row["size"]].'</td> <td style="text-align: left;">'.$rateJson[$row["size"]] * $row["quantity"].' </td></tr>';
